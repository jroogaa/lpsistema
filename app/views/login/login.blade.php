...
<html lang="es" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/loginCSS/style3.css" />
		<link rel="stylesheet" type="text/css" href="css/loginCSS/animate-custom.css" />
    </head>
    <body>
        <div class="container">
            <!-- Codrops top bar -->
            ...
            <header>
                <h1>Login LP Analistas y Consultores 
                    <span>Usuarios</span>
                </h1>
                        ...
                        <div id="login" class="animate form">
                            <form  action="mysuperscript.php" autocomplete="on"> 
                                ...
                                <p class="change_link">
									...
									<a href="#toregister" class="to_register">Nuevo</a>
								</p>
                            </form>
                        </div>
